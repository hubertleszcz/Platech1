...
public class Main {
    public static void main(String[] args) {
        Set<Mage> mageSet;
        //if(args[0].equals("0")) mageSet = new HashSet<>();
        ...
        Mage firstMainMage = new Mage("Dewastator5000", 16, 22.6, "2");
        Mage secondMainMage = new Mage("UltraKoxu12", 14, 15.4, "2");
        Mage thirdMainMage = new Mage("Leszcz", 21, 8.5, "2");
        Mage firstApprentice = new Mage("Turbosprezarka221", 7, 5.5, "2");
        Mage secondApprentice = new Mage("Godzilla404", 6, 4.5, "2");
        Mage thirdApprentice = new Mage("SuperCzarodziej123", 9, 3.5, "2");
        Mage forthApprentice = new Mage("KennyTheReaper2010", 2, 2.0, "2");
        Mage fifthApprentice = new Mage("GigaChad15", 100, 100.5, "2");
        Mage firstSubApprentice = new Mage("Slaby1", 1, 1.0, "2");
        Mage secondSubApprentice = new Mage("Slaby2", 1, 1.1, "2");
